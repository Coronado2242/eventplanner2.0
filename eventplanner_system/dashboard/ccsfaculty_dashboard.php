...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['proposal_id'], $_POST['action']) && 
    ...
    if ($action === 'approve_financial') {
        ...
        header("Location: ccsfaculty_dashboard.php?financial_disapproved=1&tab=financial");
        exit;
    }
}
    ...
    <div class="admin-info">
      ...
      <div class="user-dropdown" id="userDropdown">
        ...
        <div class="dropdown-menu" id="dropdownMenu" style="display:none;">
          <?php if ($_SESSION['role'] === 'CCSFaculty'): ?>
            <a href="ccsfaculty_dashboard.php">CCS Faculty Dashboard</a>
          <?php endif; ?>
...
<form method="POST" action="ccssbotreasurer_dashboard.php" style="display: inline;">
  ...
  Disapprove
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <tr><td colspan="8" class="text-center">No proposals found for Faculty.</td></tr>
    <?php endif; ?>
    </tbody>
</table>
...
if ($result->num_rows > 0) {
    ...
    echo '<div class="alert alert-info text-center">No requirements found for SBO Faculty.</div>';
}
?>
</div>
...
<div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="approveModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <form method="POST" action="ccsfaculty_dashboard.php">
   ...
   <form method="POST" action="ccsfaculty_dashboard.php">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="level" value="CCSFaculty">
...
<div id="financialReportContent" class="content" style="display:none;">
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-hover table-striped text-center align-middle shadow-sm rounded">
      ...
      <tbody>
      <?php
      $query = "SELECT * FROM sooproposal WHERE submit = 'Submitted' AND level = 'CCS Financial Adviser'";
      ...
      <tr>
        ...
        <td>
<form method="POST" action="ccsfaculty_dashboard.php" onsubmit="return confirmSubmit(this);">
  <input type="hidden" name="proposal_id" value="<?= $row['id'] ?>">
